      ...
      if (autocompleteRef.current) {
        event.current = autocompleteRef.current.addListener("place_changed", function () {
          if (onPlaceSelected && autocompleteRef && autocompleteRef.current) {
            ...
            var country_code = place === null || place === void 0 ? void 0 : place.address_components.find(function (x) {
              return x.types[0] == "country";
            });
            var political = place === null || place === void 0 ? void 0 : place.address_components.find(function (x) {
